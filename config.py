...
ATTACK_LR_MODEL  = os.path.join(MODELS_DIR, "attack_LogReg_model.02")
HEALTH_LR_MODEL  = os.path.join(MODELS_DIR, "health_LogReg_model.02")
ATTACK_MLP_MODEL = os.path.join(MODELS_DIR, "attack_MLP_model.02")
HEALTH_MLP_MODEL = os.path.join(MODELS_DIR, "health_MLP_model.02")
